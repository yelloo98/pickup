...
class MainController extends Controller
{
	...
	public function getIndex(Request $request)
	{
        ...
        //# 신규 상품 / 슬롯에 새로 들어온 상품
        $view->newProduct = ProductStock::leftjoin('product','product.id','product_stock.product_id')->where('product.store_id', $store_id)->select('product_stock.*')->orderBy('product_stock.id','DESC')->limit(10)->get();
        //# 인기 상품 / 구매량이 많은 상품
